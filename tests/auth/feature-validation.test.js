...
async function testCallbackHandler() {
  ...
  testFileContent('src/auth-callback.js', [
...
async function testPopupIntegration() {
  ...
  testFileContent('src/popup.html', [
    'id="authSection"',
    'id="userProfile"',
    'id="authButtons"',
    'id="signInBtn"',
...
async function testServiceWorkerIntegration() {
  ...
  testFileContent('src/service-worker.js', [
    'GET_CLERK_KEY',
    'AUTH_CALLBACK_SUCCESS',
...
async function testManifestConfiguration() {
  ...
  assert(manifest.permissions && manifest.permissions.includes('identity'), 
...
async function testOptionsPage() {
  ...
  testFileContent('src/options.html', [
    'clerk_publishable_key',
    'Authentication',
    'Clerk Dashboard'
  ], 'Options HTML');
  
  testFileContent('src/options.js', [
    'clerk_publishable_key',
...
async function testIntegrationPoints() {
  ...
  const callbackHtml = fs.readFileSync(path.join(__dirname, '../../src/clerk-callback.html'), 'utf8');

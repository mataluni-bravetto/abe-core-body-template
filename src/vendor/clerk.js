      ...
      !function(e, t) {
        ...
        return function() {
          var e, t, n, r, i = { 2163: function(e2, t2, n2) {
                ...
                if (this.isSpeedy) {
                  var n3 = function(e5) {
                    ...
                    for (var t5 = 0; t5 < document.styleSheets.length; t5++)
                      if (document.styleSheets[t5].ownerNode === e5)
                  ...
                  t4.appendChild(document.createTextNode(e4));
                this.ctr++;
              }, t3.flush = function() {
            ...
            function B(e3, t3) {
              for (var n3 = "", r3 = f(e3), i3 = 0; i3 < r3; i3++)
                n3 += t3(e3[i3], i3, e3, t3) || "";
              return n3;
            }
            ...
            function G(e3, t3, n3, r3, i3, a3, s3, d2, f2) {
              for (var m2 = 0, g2 = 0, y2 = s3, v2 = 0, b2 = 0, w2 = 0, _2 = 1, S2 = 1, U2 = 1, x2 = 0, C2 = "", E2 = i3, z2 = a3, L2 = r3, j2 = C2; S2; )
                switch (w2 = x2, x2 = P()) {
                  case 40:
                  ...
                  case 0:
                    switch (x2) {
                      ...
                      case 59:
                        j2 += ";";
                      default:
                        if (p(L2 = H(j2, t3, n3, m2, g2, i3, d2, C2, E2 = [], z2 = [], y2), a3), 123 === x2)
                          if (0 === g2)
                            G(j2, t3, L2, L2, E2, a3, y2, d2, z2);
                          else
                            switch (99 === v2 && 110 === u(j2, 3) ? 100 : v2) {
                              case 100:
                              case 108:
                              case 109:
                              case 115:
            ...
            function H(e3, t3, n3, r3, o3, a3, l2, u2, h2, p2, m2) {
              for (var g2 = o3 - 1, y2 = 0 === o3 ? a3 : [""], v2 = f(y2), b2 = 0, w2 = 0, S2 = 0; b2 < r3; ++b2)
                for (var k2 = 0, P2 = d(e3, g2 + 1, g2 = i2(w2 = l2[b2])), O2 = e3; k2 < v2; ++k2)
                  (O2 = s2(w2 > 0 ? y2[k2] + " " + P2 : c(P2, /&\f/g, y2[k2]))) && (h2[S2++] = O2);
            ...
            var Z = function(e3, t3, n3) {
              for (var r3 = 0, i3 = 0; r3 = i3, i3 = O(), 38 === r3 && 12 === i3 && (t3[n3] = 1), !x(i3); )
                P();
              return U(e3, v);
            }, Q = /* @__PURE__ */ new WeakMap(), X = function(e3) {
              if ("rule" === e3.type && e3.parent && !(e3.length < 1)) {
                for (var t3 = e3.value, n3 = e3.parent, r3 = e3.column === n3.column && e3.line === n3.line; "rule" !== n3.type; )
                  if (!(n3 = n3.parent))
                    return;
                if ((1 !== e3.props.length || 58 === t3.charCodeAt(0) || Q.get(n3)) && !r3) {
                  ...
                  }(t3, i3), s3 = n3.props, c2 = 0, l2 = 0; c2 < a3.length; c2++)
                    for (var u2 = 0; u2 < s3.length; u2++, l2++)
                      e3.props[l2] = i3[c2] ? a3[c2].replace(/&\f/g, s3[u2]) : s3[u2] + " " + a3[c2];
                }
              }
            }, ee = function(e3) {
              if ("decl" === e3.type) {
            ...
            var ne = [function(e3, t3, n3, r3) {
              ...
              i3 = e3.container || document.head, Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="' + t3 + ' "]'), function(e4) {
                for (var t4 = e4.getAttribute("data-emotion").split(" "), n4 = 1; n4 < t4.length; n4++)
                  s3[t4[n4]] = true;
                c2.push(e4);
              });
              var l2, u2, d2, h2, p2 = [J, (h2 = function(e4) {
                ...
                for (var i4 = "", o4 = 0; o4 < d2; o4++)
                  i4 += u2[o4](e4, t4, n4, r3) || "";
                return i4;
              });
            ...
            var a2 = function(e3) {
              ...
              var d2 = {};
              for (var h2 in e3)
                u.call(e3, h2) && "css" !== h2 && h2 !== y && (d2[h2] = e3[h2]);
            ...
            var o2 = /[A-Z]|^ms/g, a2 = /_EMO_([^_]+?)_([^]*?)_EMO_/g, s2 = function(e3) {
              ...
              switch (e3) {
                ...
                case "animationName":
                  if ("string" == typeof t3)
                    return t3.replace(a2, function(e4, t4, n3) {
            ...
            function d(e3, t3, n3) {
              ...
              switch (typeof n3) {
                ...
                case "object":
                  if (1 === n3.anim)
                    return h = { name: n3.name, styles: n3.styles, next: h }, n3.name;
                  if (void 0 !== n3.styles) {
                    var r3 = n3.next;
                    if (void 0 !== r3)
                      for (; void 0 !== r3; )
                        h = { name: r3.name, styles: r3.styles, next: h }, r3 = r3.next;
                    return n3.styles + ";";
                  }
                  return function(e4, t4, n4) {
                    var r4 = "";
                    if (Array.isArray(n4))
                      ...
                      for (var o4 in n4) {
                        var a4 = n4[o4];
                        if ("object" != typeof a4)
                          null != t4 && void 0 !== t4[a4] ? r4 += o4 + "{" + t4[a4] + "}" : c(a4) && (r4 += l(o4) + ":" + u(o4, a4) + ";");
            ...
            var h, f = /label:\s*([^\s;\n{]+)\s*(;|$)/g, p = function(e3, t3, n3) {
              ...
              for (var a3 = 1; a3 < e3.length; a3++)
                i3 += d(n3, t3, e3[a3]), r3 && (i3 += o3[a3]);
              f.lastIndex = 0;
              for (var s3, c2 = ""; null !== (s3 = f.exec(i3)); )
                c2 += "-" + s3[1];
              var l2 = function(e4) {
                for (var t4, n4 = 0, r4 = 0, i4 = e4.length; i4 >= 4; ++r4, i4 -= 4)
                  t4 = 1540483477 * (65535 & (t4 = 255 & e4.charCodeAt(r4) | (255 & e4.charCodeAt(++r4)) << 8 | (255 & e4.charCodeAt(++r4)) << 16 | (255 & e4.charCodeAt(++r4)) << 24)) + (59797 * (t4 >>> 16) << 16), n4 = 1540483477 * (65535 & (t4 ^= t4 >>> 24)) + (59797 * (t4 >>> 16) << 16) ^ 1540483477 * (65535 & n4) + (59797 * (n4 >>> 16) << 16);
                switch (i4) {
                  case 3:
            ...
            function c(e3) {
              for (var t3 = "", n3 = 0; n3 < e3; n3++)
                t3 += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz"[Math.floor(61 * Math.random())];
              return t3;
            }
            var l = function() {
              function e3() {
            ...
            e2.exports = function(e3) {
              ...
              for (var i2, o2 = t2.call(arguments, 1), a2 = Math.max(0, r2.length - o2.length), s2 = [], c = 0; c < a2; c++)
                s2.push("$" + c);
            ...
            var v = function e3(t3) {
              ...
              if (_(b, r3) && (r3 = "%" + (n3 = b[r3])[0] + "%"), _(g, r3)) {
                var o3 = g[r3];
                if (o3 === p && (o3 = v(r3)), void 0 === o3 && !t3)
                  throw new a2("intrinsic " + e3 + " exists, but is not available. Please file an issue!");
            ...
            e2.exports = function(e3, t3) {
              if ("string" != typeof e3 || 0 === e3.length)
                throw new a2("intrinsic name must be a non-empty string");
              if (arguments.length > 1 && "boolean" != typeof t3)
                throw new a2('"allowMissing" argument must be a boolean');
              if (null === A(/^%?[^%]*%?$/, e3))
              ...
              for (var h2 = 1, f2 = true; h2 < n3.length; h2 += 1) {
                ...
                if ("constructor" !== p2 && f2 || (u2 = true), _(g, s3 = "%" + (r3 += "." + p2) + "%"))
                  l2 = g[s3];
                else if (null != l2) {
                  if (!(p2 in l2)) {
                    if (!t3)
                      throw new a2("base intrinsic for " + e3 + " exists, but the property is not available.");
                    return;
                  }
                  if (c && h2 + 1 >= n3.length) {
                    var v2 = c(l2, p2);
            ...
            e2.exports = function(e3, t2) {
              ...
              for (var n2, r2 = String(e3), i2 = "", o2 = !!t2 && !!t2.extended, a2 = !!t2 && !!t2.globstar, s2 = false, c = t2 && "string" == typeof t2.flags ? t2.flags : "", l = 0, u = r2.length; l < u; l++)
                switch (n2 = r2[l]) {
                  case "/":
                  case "$":
                  case "^":
            ...
            e2.exports = function e3(t3, n3, r3, i3) {
              var s3 = n3 || {};
              if (B(s3, "quoteStyle") && "single" !== s3.quoteStyle && "double" !== s3.quoteStyle)
                throw new TypeError('option "quoteStyle" must be "single" or "double"');
              if (B(s3, "maxStringLength") && ("number" == typeof s3.maxStringLength ? s3.maxStringLength < 0 && s3.maxStringLength !== 1 / 0 : null !== s3.maxStringLength))
                throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
              var c2 = !B(s3, "customInspect") || s3.customInspect;
              if ("boolean" != typeof c2 && "symbol" !== c2)
                throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
              if (B(s3, "indent") && null !== s3.indent && "	" !== s3.indent && !(parseInt(s3.indent, 10) === s3.indent && s3.indent > 0))
                throw new TypeError('option "indent" must be "\\t", an integer > 0, or `null`');
              if (B(s3, "numericSeparator") && "boolean" != typeof s3.numericSeparator)
              ...
              if (void 0 === r3 && (r3 = 0), r3 >= A2 && A2 > 0 && "object" == typeof t3)
                return F(t3) ? "[Array]" : "[Object]";
              ...
              if ((x2 = t3) && "object" == typeof x2 && ("undefined" != typeof HTMLElement && x2 instanceof HTMLElement || "string" == typeof x2.nodeName && "function" == typeof x2.getAttribute)) {
                for (var ne = "<" + _.call(String(t3.nodeName)), re = t3.attributes || [], ie = 0; ie < re.length; ie++)
                  ne += " " + re[ie].name + "=" + j($(re[ie].value), "double", s3);
              ...
              if ("object" == typeof t3 && c2) {
                if (L && "function" == typeof t3[L] && T)
                  return T(t3, { depth: A2 - r3 });
                if ("symbol" !== c2 && "function" == typeof t3.inspect)
                  return t3.inspect();
              }
              if (function(e4) {
                if (!o2 || !e4 || "object" != typeof e4)
                  return false;
                try {
                  o2.call(e4);
                  try {
            ...
            function X(e3, t3) {
              ...
              for (var c2 in e3)
                B(e3, c2) && (n3 && String(Number(c2)) === c2 && c2 < e3.length || E && o3["$" + c2] instanceof Symbol || (S.call(/[^\w$]/, c2) ? r3.push(t3(c2, e3) + ": " + t3(e3[c2], e3)) : r3.push(c2 + ": " + t3(e3[c2], e3))));
              if ("function" == typeof x)
                for (var l2 = 0; l2 < a3.length; l2++)
                  M.call(e3, a3[l2]) && r3.push("[" + t3(a3[l2]) + "]: " + t3(e3[a3[l2]], e3));
              return r3;
            }
          }, 1830: function(e2) {
            "use strict";
            ...
            var r2 = n2(1539), i2 = Object.prototype.hasOwnProperty, o2 = Array.isArray, a2 = { allowDots: false, allowPrototypes: false, allowSparse: false, arrayLimit: 20, charset: "utf-8", charsetSentinel: false, comma: false, decoder: r2.decode, delimiter: "&", depth: 5, ignoreQueryPrefix: false, interpretNumericEntities: false, parameterLimit: 1e3, parseArrays: true, plainObjects: false, strictNullHandling: false }, s2 = function(e3) {
              ...
              if (e3) {
                ...
                if (l2) {
                  if (!n3.plainObjects && i2.call(Object.prototype, l2) && !n3.allowPrototypes)
                    return;
                  u.push(l2);
                }
                for (var d = 0; n3.depth > 0 && null !== (s3 = a3.exec(o3)) && d < n3.depth; ) {
                  if (d += 1, !n3.plainObjects && i2.call(Object.prototype, s3[1].slice(1, -1)) && !n3.allowPrototypes)
                    return;
                  u.push(s3[1]);
                }
            ...
            e2.exports = function(e3, t3) {
              ...
              for (var u = "string" == typeof e3 ? function(e4, t4) {
                ...
                if (t4.charsetSentinel)
                  for (n4 = 0; n4 < h2.length; ++n4)
                    0 === h2[n4].indexOf("utf8=") && ("utf8=%E2%9C%93" === h2[n4] ? p2 = "utf-8" : "utf8=%26%2310003%3B" === h2[n4] && (p2 = "iso-8859-1"), f2 = n4, n4 = h2.length);
                for (n4 = 0; n4 < h2.length; ++n4)
                  if (n4 !== f2) {
            ...
            var r2 = n2(7575), i2 = n2(1539), o2 = n2(1830), a2 = Object.prototype.hasOwnProperty, s2 = { brackets: function(e3) {
              ...
              if ("function" == typeof f2 ? O = f2(n3, O) : O instanceof Date ? O = v(O) : "comma" === o3 && c(O) && (O = i2.maybeMap(O, function(e4) {
                ...
                if (s3)
                  return h2 && !_ ? h2(n3, p.encoder, S, "key", b) : n3;
                O = "";
              }
              if ("string" == typeof (P = O) || "number" == typeof P || "boolean" == typeof P || "symbol" == typeof P || "bigint" == typeof P || i2.isBuffer(O)) {
                if (h2) {
                  ...
                  if ("comma" === o3 && _) {
                    for (var I = l.call(String(O), ","), M = "", R = 0; R < I.length; ++R)
                      M += (0 === R ? "" : ",") + w(h2(I[R], p.encoder, S, "value", b));
              ...
              if (void 0 === O)
                return T;
              if ("comma" === o3 && c(O))
                z = [{ value: O.length > 0 ? O.join(",") || null : void 0 }];
              else if (c(f2))
                z = f2;
              else {
                var N = Object.keys(O);
            ...
            e2.exports = function(e3, t3) {
              var n3, i3 = e3, l2 = function(e4) {
                ...
                var n4 = o2.default;
                if (void 0 !== e4.format) {
                  if (!a2.call(o2.formatters, e4.format))
            ...
            e2.exports = { arrayToObject: s2, assign: function(e3, t3) {
              ...
              for (var t3 = [{ obj: { o: e3 }, prop: "o" }], n3 = [], r3 = 0; r3 < t3.length; ++r3)
                for (var i3 = t3[r3], a3 = i3.obj[i3.prop], s3 = Object.keys(a3), c = 0; c < s3.length; ++c) {
                  var l = s3[c], u = a3[l];
              ...
              return function(e4) {
                for (; e4.length > 1; ) {
                  ...
                  if (o2(n4)) {
                    for (var r4 = [], i4 = 0; i4 < n4.length; ++i4)
                      void 0 !== n4[i4] && r4.push(n4[i4]);
                    t4.obj[t4.prop] = r4;
                  }
                }
              }(t3), e3;
              ...
              if (0 === e3.length)
                return e3;
              var s3 = e3;
              if ("symbol" == typeof e3 ? s3 = Symbol.prototype.toString.call(e3) : "string" != typeof e3 && (s3 = String(e3)), "iso-8859-1" === n3)
                return escape(s3).replace(/%u[0-9a-f]{4}/gi, function(e4) {
            ...
            function l(e3, t3, n3) {
              ...
              for (r3 in void 0 !== n3 && (l2 = "" + n3), void 0 !== t3.key && (l2 = "" + t3.key), void 0 !== t3.ref && (u = t3.ref), t3)
                a2.call(t3, r3) && !c.hasOwnProperty(r3) && (o3[r3] = t3[r3]);
              if (e3 && e3.defaultProps)
                for (r3 in t3 = e3.defaultProps)
                  void 0 === o3[r3] && (o3[r3] = t3[r3]);
            ...
            function O(e3, t3, r3) {
              ...
              if (null != t3)
                for (i3 in void 0 !== t3.ref && (s3 = t3.ref), void 0 !== t3.key && (a3 = "" + t3.key), t3)
                  S.call(t3, i3) && !P.hasOwnProperty(i3) && (o3[i3] = t3[i3]);
              ...
              if (e3 && e3.defaultProps)
                for (i3 in c2 = e3.defaultProps)
                  void 0 === o3[i3] && (o3[i3] = c2[i3]);
            ...
            function C(e3, t3, i3, o3, a3) {
              ...
              if (c2)
                return a3 = a3(c2 = e3), e3 = "" === o3 ? "." + x(c2, 0) : o3, _(a3) ? (i3 = "", null != e3 && (i3 = e3.replace(U, "$&/") + "/"), C(a3, t3, i3, "", function(e4) {
                  return e4;
              ...
              }(e3), "function" == typeof u2)
                for (e3 = u2.call(e3), l2 = 0; !(s3 = e3.next()).done; )
                  c2 += C(s3 = s3.value, t3, i3, u2 = o3 + x(s3, l2++), a3);
              else if ("object" === s3)
            ...
            t2.Children = { map: E, forEach: function(e3, t3, n3) {
              ...
              if (null != t3) {
                if (void 0 !== t3.ref && (a3 = t3.ref, s3 = k.current), void 0 !== t3.key && (o3 = "" + t3.key), e3.type && e3.type.defaultProps)
                  var c2 = e3.type.defaultProps;
                for (l2 in t3)
                  S.call(t3, l2) && !P.hasOwnProperty(l2) && (i3[l2] = void 0 === t3[l2] && void 0 !== c2 ? c2[l2] : t3[l2]);
              }
            ...
            var t2 = function(e3) {
              ...
              function U(e4, n3) {
                ...
                if (i3 === t3)
                  return n3.delegate = null, "throw" === r3 && e4.iterator.return && (n3.method = "return", n3.arg = t3, U(e4, n3), "throw" === n3.method) || "return" !== r3 && (n3.method = "throw", n3.arg = new TypeError("The iterator does not provide a '" + r3 + "' method")), g;
                var o3 = d(i3, e4.iterator, n3.arg);
                if ("throw" === o3.type)
                  return n3.method = "throw", n3.arg = o3.arg, n3.delegate = null, g;
                var a3 = o3.arg;
                ...
                if (e4) {
                  ...
                  if (!isNaN(e4.length)) {
                    var i3 = -1, o3 = function n4() {
                      for (; ++i3 < e4.length; )
                        if (r2.call(e4, i3))
                          return n4.value = e4[i3], n4.done = false, n4;
              ...
              return v.prototype = b, i2(k, "constructor", { value: b, configurable: true }), i2(b, "constructor", { value: v, configurable: true }), v.displayName = l(b, c, "GeneratorFunction"), e3.isGeneratorFunction = function(e4) {
                ...
                if (this.prev = 0, this.next = 0, this.sent = this._sent = t3, this.done = false, this.delegate = null, this.method = "next", this.arg = t3, this.tryEntries.forEach(C), !e4)
                  for (var n3 in this)
                    "t" === n3.charAt(0) && r2.call(this, n3) && !isNaN(+n3.slice(1)) && (this[n3] = t3);
              }, stop: function() {
                this.done = true;
                ...
                for (var t4 = this.tryEntries.length - 1; t4 >= 0; --t4) {
                  ...
                  if (n3.finallyLoc === e4)
                    return this.complete(n3.completion, n3.afterLoc), C(n3), g;
                }
              }, catch: function(e4) {
                for (var t4 = this.tryEntries.length - 1; t4 >= 0; --t4) {
                  var n3 = this.tryEntries[t4];
            ...
            var r2 = n2(528), i2 = n2(9818), o2 = n2(8660), a2 = r2("%TypeError%"), s2 = r2("%WeakMap%", true), c = r2("%Map%", true), l = i2("WeakMap.prototype.get", true), u = i2("WeakMap.prototype.set", true), d = i2("WeakMap.prototype.has", true), h = i2("Map.prototype.get", true), f = i2("Map.prototype.set", true), p = i2("Map.prototype.has", true), m = function(e3, t3) {
              for (var n3, r3 = e3; null !== (n3 = r3.next); r3 = n3)
                if (n3.key === t3)
                  return r3.next = n3.next, n3.next = e3.next, e3.next = n3, n3;
            };
            e2.exports = function() {
              var e3, t3, n3, r3 = { assert: function(e4) {
                if (!r3.has(e4))
                  throw new a2("Side channel does not contain " + o2(e4));
              }, get: function(r4) {
...
For more information contact us at ${t3}`);
            ...
            function l(e3) {
              ...
              return { buildEmailAddress: function(t4) {
                ...
                const h = await async function(e4) {
                  ...
                  for await (const r3 of [n4, ...t3].filter((e5) => e5))
                    if (false === await r3(e4))
                      return false;
                  return true;
                }(i4), f = "GET" === u ? "GET" : "POST";
                let p;
                ...
                return await async function(e4, t4) {
                  ...
                  for await (const i5 of [r3, ...n3].filter((e5) => e5))
                    if (false === await i5(e4, t4))
                      return false;
                  return true;
                }(i4, v), v;
              } };
            ...
            class o2 {
              ...
              static async _fetch(e3, t3 = {}) {
                ...
                if (("GET" !== e3.method || t3.forceUpdateClient) && this._updateClient(a3), s3 >= 200 && s3 <= 299)
                  return a3;
                if (401 === s3 && await o2.clerk.handleUnauthenticated(), s3 >= 400)
                  throw new w.LR(c2, { data: null == a3 ? void 0 : a3.errors, status: s3 });
                return null;
              }
              ...
              constructor(e3) {
                super(), this.pathRoot = "/organizations", this.publicMetadata = {}, this.membersCount = 0, this.pendingInvitationsCount = 0, this.update = async (e4) => this._basePatch({ body: e4 }), this.getRoles = async (e4) => await o2._fetch({ path: `/organizations/${this.id}/roles`, method: "GET", search: C(e4) }, { forceUpdateClient: true }).then((e5) => {
                  ...
                  return (null == e4 ? void 0 : e4.limit) && (0, f.io)("limit", "Use `pageSize` instead in Organization.getMemberships.", "organization:getMemberships:limit"), (null == e4 ? void 0 : e4.offset) && (0, f.io)("offset", "Use `initialPage` instead in Organization.limit.", "organization:getMemberships:offset"), await o2._fetch({ path: `/organizations/${this.id}/memberships`, method: "GET", search: t3 ? e4 : C(e4) }, { forceUpdateClient: true }).then((e5) => {
                    if (t3)
                      return (null == e5 ? void 0 : e5.response).map((e6) => new N(e6));
                  ...
                  if (null === e4)
                    return await o2._fetch({ path: `/organizations/${this.id}/logo`, method: "DELETE" }).then((e5) => new z(null == e5 ? void 0 : e5.response));
                  let t3, n3;
            ...
            b = N, N.retrieve = async (e3) => {
              ...
              return (null == e3 ? void 0 : e3.limit) && (0, f.io)("limit", "Use `pageSize` instead in OrganizationMembership.retrieve.", "organization-membership:limit"), (null == e3 ? void 0 : e3.offset) && (0, f.io)("offset", "Use `initialPage` instead in OrganizationMembership.retrieve.", "organization-membership:offset"), await o2._fetch({ path: "/me/organization_memberships", method: "GET", search: t3 ? e3 : C(e3) }).then((e4) => {
                if (t3)
                  return (null == e4 ? void 0 : e4.response).map((e5) => new b(e5));
            ...
            class H extends o2 {
              ...
              constructor(e3) {
                super(), $.add(this), this.pathRoot = "/client/sessions", this.end = () => (u.clear(), this._basePost({ action: "end" })), this.remove = () => (u.clear(), this._basePost({ action: "remove" })), this.touch = () => this._basePost({ action: "touch", body: { active_organization_id: this.lastActiveOrganizationId } }), this.clearCache = () => u.clear(), this.getToken = async (e4) => (0, _.Nv)(() => this._getToken(e4), { shouldRetry: (e5, t3) => !(0, w.nc)(e5) && t3 < 4 }), this.checkAuthorization = (e4) => {
                  ...
                  if (r3)
                    return r3.tokenResolver.then((e5) => G(this, $, "m", J).call(this, e5));
              ...
              async _getToken(e3) {
                ...
                if (G(this, W, "f").call(this, n3))
                  return G(this, B, "f").call(this, { template: n3, leewayInSeconds: t3, skipCache: r3 });
            ...
            class X extends o2 {
              constructor(e3 = null) {
                super(), this.pathRoot = "/client/sign_ins", this.status = null, this.supportedIdentifiers = [], this.supportedFirstFactors = [], this.supportedSecondFactors = [], this.firstFactorVerification = new S(null), this.secondFactorVerification = new S(null), this.identifier = null, this.createdSessionId = null, this.userData = new ee(null), this.create = (e4) => this._basePost({ path: this.pathRoot, body: e4 }), this.resetPassword = (e4) => this._basePost({ body: e4, action: "reset_password" }), this.prepareFirstFactor = (e4) => {
                  ...
                  var n3, r3;
                  if (null === (n3 = X.clerk.__unstable__environment) || void 0 === n3 ? void 0 : n3.userSettings.passwordSettings)
                    return (0, Q.G)({ ...null === (r3 = X.clerk.__unstable__environment) || void 0 === r3 ? void 0 : r3.userSettings.passwordSettings, validatePassword: true })(e4, t3);
                }, this.fromJSON(e3);
              }
              fromJSON(e3) {
            ...
            class re extends o2 {
              constructor(e3 = null) {
                super(), this.pathRoot = "/client/sign_ups", this.status = null, this.requiredFields = [], this.optionalFields = [], this.missingFields = [], this.unverifiedFields = [], this.verifications = new k(null), this.username = null, this.firstName = null, this.lastName = null, this.emailAddress = null, this.phoneNumber = null, this.web3wallet = null, this.hasPassword = false, this.unsafeMetadata = {}, this.createdSessionId = null, this.createdUserId = null, this.abandonAt = null, this.create = async (e4) => {
                  ...
                  if (!this.shouldBypassCaptchaForAttempt(e4) && i3 && r3 && o3 && c2)
                    try {
                      ...
                      if (!l2.captchaError)
                        throw new w.cR(l2.message, { code: "captcha_unavailable" });
                  ...
                  if (n3 && (0, _.io)("generateSignature", "Use signature field instead."), t3)
                    return this.attemptVerification({ signature: t3, strategy: "web3_metamask_signature" });
                  ...
                  const s3 = () => {
                    ...
                    if ((0, w.$R)(e5) && (0, w.rZ)(e5))
                      return await re.clerk.__unstable__environment.reload(), s3();
                    throw e5;
                  ...
                  var n3, r3;
                  if (null === (n3 = re.clerk.__unstable__environment) || void 0 === n3 ? void 0 : n3.userSettings.passwordSettings)
                    return (0, Q.G)({ ...null === (r3 = re.clerk.__unstable__environment) || void 0 === r3 ? void 0 : r3.userSettings.passwordSettings, validatePassword: true })(e4, t3);
                }, this.fromJSON(e3);
              }
              fromJSON(e3) {
...
(This notice only appears in development)`;
            ...
            const r2 = ({ signUp: e3, verifyEmailPath: t3, verifyPhonePath: n3, navigate: r3, handleComplete: i2, redirectUrl: o2 = "", redirectUrlComplete: a2 = "" }) => {
              var s2, c;
              if ("complete" === e3.status)
                return i2 && i2();
              if ("missing_requirements" === e3.status) {
                if (e3.missingFields.some((e4) => "saml" === e4))
                  return e3.authenticateWithRedirect({ strategy: "saml", redirectUrl: o2, redirectUrlComplete: a2, continueSignUp: true });
                if ((null === (s2 = e3.unverifiedFields) || void 0 === s2 ? void 0 : s2.includes("email_address")) && t3)
                  return r3(t3);
                if ((null === (c = e3.unverifiedFields) || void 0 === c ? void 0 : c.includes("phone_number")) && n3)
                  return r3(n3);
              }
            };
            ...
            var d = function e3(t3, n3) {
              function r3(e4, r4, i3) {
                if ("undefined" != typeof document) {
                  ...
                  var o3 = "";
                  for (var a3 in i3)
                    i3[a3] && (o3 += "; " + a3, true !== i3[a3] && (o3 += "=" + i3[a3].split(";")[0]));
            ...
            function E(e3, t3 = {}) {
              if (!(t3.requireType && typeof e3 !== t3.requireType || C(e3)))
                return e3;
            }
            ...
            const L = () => {
              ...
              if (!(0, N.M)())
                return { isUnloading: L, onPageVisible: L };
            ...
            function Y(e3) {
              ...
              return window.addEventListener("beforeunload", async () => {
                ...
                if (await t3.acquireLock(e3, 5e3))
                  try {
                    return await n3();
                  } finally {
                    await t3.releaseLock(e3);
            ...
            const ee = (e3, { ctx: t3, queryParams: n3, displayConfig: r3, options: i3 }, o3 = true) => {
              ...
              const t3 = (t4) => {
                const n4 = e3[t4];
                if (n4 && n4 !== e3.displayConfig[t4])
                  return n4.startsWith("/") ? window.location.origin + n4 : n4;
            ...
            var ne = n2(1777);
            const re = (e3) => {
              if ((e3 || "").includes("gravatar") || (e3 || "").includes("avatar_placeholder"))
                return true;
              try {
            ...
            function p(e3 = window.location.hostname) {
              ...
              for (let i3 = t3.length - 1; i3 > 0; i3--)
                n3.unshift(t3[i3]), r3.push(n3.join("."));
              return r3;
            }
            function m(e3, t3 = {}) {
              ...
              if (c2 instanceof URLSearchParams && c2.forEach((e4, t4) => {
                ...
                const t4 = (0, a2.v)(i3 || "");
                for (const [r4, i4] of Object.entries(t4))
                  e4.searchParams.append(r4, i4);
            ...
            const v = (e3) => (e3 || "").replace(/\/+$/, ""), b = (e3) => (e3 || "").replace(/^\/+/, ""), w = (e3, t3) => t3.origin === e3.origin ? y(e3) : `${e3}`, _ = (e3, t3 = {}) => {
              ...
              for (const [o3, a3] of Object.entries(t3))
                a3 && i3.append((0, r2.C8)(o3), a3);
...
${t4.message}`);
            ...
            var r2 = (...e3) => {
              ...
              if (null == c || c.addEventListener("message", s3), !c)
...
${t3}`));
            ...
            var r2 = Object.defineProperty, i2 = Object.getOwnPropertyDescriptor, o2 = Object.getOwnPropertyNames, a2 = Object.prototype.hasOwnProperty, s2 = (e3, t3) => {
              for (var n3 in t3)
                r2(e3, n3, { get: t3[n3], enumerable: true });
            }, c = (e3, t3, n3, s3) => {
              if (t3 && "object" == typeof t3 || "function" == typeof t3)
                for (let c2 of o2(t3))
                  a2.call(e3, c2) || c2 === n3 || r2(e3, c2, { get: () => t3[c2], enumerable: !(s3 = i2(t3, c2)) || s3.enumerable });
              return e3;
...
Message:${this.message}`, Object.setPrototypeOf(this, e3.prototype), this.code = n3, this.message = t3, this.clerkRuntimeError = true;
            ...
            var h = (e3) => {
              const t3 = (n3) => {
                if (!n3)
                  return n3;
                if (Array.isArray(n3))
                  return n3.map((e4) => "object" == typeof e4 || Array.isArray(e4) ? t3(e4) : e4);
            ...
            const g = (e3) => {
              ...
              let i3, o3;
              if (u(e3) !== e3 || r3 || n3 == RegExp)
                i3 = r3 ? e3.toJSON() : "symbol" == t3 ? e3.toString() : "string" == t3 ? JSON.stringify(e3) : "" + e3;
              else {
                if (i3 = p.get(e3), i3)
                  return i3;
                if (i3 = ++m + "~", p.set(e3, i3), n3 == Array) {
                  for (i3 = "@", o3 = 0; o3 < e3.length; o3++)
                    i3 += g(e3[o3]) + ",";
                  p.set(e3, i3);
                }
                if (n3 == u) {
            ...
            async function L(...e3) {
              ...
              if (h(n3)) {
                ...
                for (const n4 of i4)
                  !/^\$(inf|sub)\$/.test(n4) && e4(t3.get(n4)._k) && r4.push(n4);
              ...
              async function m2(n4) {
                ...
                if (A2 && (c2 = h(c2) ? c2(E2, x2) : c2, f2({ data: c2, _c: E2 })), h(P2))
                  try {
                    P2 = P2(E2);
                  } catch (M2) {
                    S2 = M2;
            ...
            const Z = (e3) => z(e3)[0], Q = a2.use || ((e3) => {
              ...
              const { cache: r3, compare: i3, suspense: o3, fallbackData: c2, revalidateOnMount: u2, revalidateIfStale: p2, refreshInterval: m2, refreshWhenHidden: g2, refreshWhenOffline: v2, keepPreviousData: b2 } = n3, [S2, P2, O2, A2] = y.get(r3), [U2, x2] = z(e3), M2 = (0, a2.useRef)(false), R2 = (0, a2.useRef)(false), T2 = (0, a2.useRef)(U2), j2 = (0, a2.useRef)(t3), $2 = (0, a2.useRef)(n3), F2 = () => $2.current, D2 = () => F2().isVisible() && F2().isOnline(), [W2, V2, B2, J2] = k(r3, U2), q2 = (0, a2.useRef)({}).current, G2 = d(c2) ? n3.fallback[U2] : c2, H2 = (e4, t4) => {
                ...
                const t4 = j2.current;
                if (!U2 || !t4 || R2.current || F2().isPaused())
                  return false;
                let r4, o4, a3 = true;
                ...
                try {
                  ...
                  }, n3.loadingTimeout), O2[U2] = [t4(x2), N()]), [r4, o4] = O2[U2], r4 = await r4, c3 && setTimeout(m3, n3.dedupingInterval), !O2[U2] || O2[U2][1] !== o4)
                    return c3 && u3() && F2().onDiscarded(U2), false;
                  f2.error = l;
                  const e5 = P2[U2];
                  if (!d(e5) && (o4 <= e5[0] || o4 <= e5[1] || 0 === e5[1]))
                    return p3(), c3 && u3() && F2().onDiscarded(U2), false;
                  const s4 = W2().data;
              ...
              if (I(() => {
                ...
                const n4 = ((e5, t5, n5) => {
                  ...
                  if (0 == n5) {
                    ...
                    F2().revalidateOnReconnect && D2() && e4();
                  else {
                    if (2 == n5)
                      return ue2();
                    if (3 == n5)
            ...
            const re = Promise.resolve(), ie = /* @__PURE__ */ ((e3, t3) => (...n3) => {
              ...
              const O2 = m2 && !i3.current, A2 = e3(y2, async (e4) => {
                ...
                const [, n4] = k(o3, y2);
                let r4;
                if (h(e4) ? r4 = e4(S2()) : "number" == typeof e4 && (r4 = e4), "number" != typeof r4)
                  return re;
            ...
            function oe(e3, t3) {
              if (!e3)
                throw "string" == typeof t3 ? new Error(t3) : new Error(`${t3.displayName} not found`);
            }
            var ae = (e3, t3) => {
            ...
            var we = (e3, t3) => {
              ...
              for (const a3 of Object.keys(t3))
                l2[a3] = o3 ? t3[a3] : null != (i3 = null == e3 ? void 0 : e3[a3]) ? i3 : t3[a3];
            ...
            var Oe = { data: void 0, count: void 0, isLoading: false, isFetching: false, isError: false, page: void 0, pageCount: void 0, fetchPage: void 0, fetchNext: void 0, fetchPrevious: void 0, hasNextPage: false, hasPreviousPage: false, revalidate: void 0, setData: void 0 }, Ae = (e3) => {
              ...
              if (!f2)
                return { isLoaded: false, organizationList: void 0, createOrganization: void 0, setActive: void 0, userMemberships: Oe, userInvitations: Oe, userSuggestions: Oe };
          ...
          a.m = i, a.n = function(e2) {
            ...
            if (1 & r2 && (n2 = this(n2)), 8 & r2)
              return n2;
            if ("object" == typeof n2 && n2) {
              if (4 & r2 && n2.__esModule)
                return n2;
              if (16 & r2 && "function" == typeof n2.then)
                return n2;
            }
            ...
            var o2 = {};
            e = e || [null, t({}), t([]), t(t)];
            for (var s2 = 2 & r2 && n2; "object" == typeof s2 && !~e.indexOf(s2); s2 = t(s2))
              Object.getOwnPropertyNames(s2).forEach(function(e2) {
                o2[e2] = function() {
                  return n2[e2];
                };
              });
            ...
            if (!e2 && t2 && (t2.currentScript && (e2 = t2.currentScript.src), !e2)) {
              ...
              if (n2.length)
                for (var r2 = n2.length - 1; r2 > -1 && (!e2 || !/^http(s?):/.test(e2)); )
                  e2 = n2[r2--].src;
            }
            if (!e2)
            ...
            var t2 = function(t3, n3) {
              ...
              if (o2.some(function(t4) {
                ...
                for (r2 in s2)
                  a.o(s2, r2) && (a.m[r2] = s2[r2]);
                c && c(a);
              }
              for (t3 && t3(n3); l < o2.length; l++)
                i2 = o2[l], a.o(e2, i2) && e2[i2] && e2[i2][0](), e2[i2] = 0;
          ...
          return function() {
            ...
            var p, m, g, y, v, b, w, _, S, k, P, O, A, U, x, C, E, I, M, R, z, T, N, L, j, $, F, D, W, V, B, J, q, G, H, K, Y, Z, Q, X, ee, te, ne, re = a(5864), ie = function(e3, t3, n3, r3) {
              ...
              if ("function" == typeof t3 ? e3 !== t3 || !i3 : !t3.has(e3))
            ...
            class se {
              ...
              constructor(a2, s2) {
                if (this.internal_last_error = null, m.set(this, void 0), g.set(this, void 0), y.set(this, null), v.set(this, null), b.set(this, void 0), w.set(this, null), _.set(this, void 0), S.set(this, void 0), k.set(this, void 0), P.set(this, false), O.set(this, null), A.set(this, null), U.set(this, []), x.set(this, {}), C.set(this, null), this.getFapiClient = () => ie(this, S, "f"), this.isReady = () => ie(this, P, "f"), this.load = async (e3) => {
                  ...
                  var r3;
                  if (!this.client || 0 === this.client.sessions.length)
                    return;
                  const i3 = "function" == typeof e3 ? e3 : void 0, o3 = e3 && "object" == typeof e3 ? e3 : t3 || {};
                  if (!o3.sessionId || 1 === this.client.activeSessions.length)
                    return await this.client.destroy(), this.setActive({ session: null, beforeEmit: (0, n2.ez)(i3) });
                  ...
                  if (this.assertComponentsReady(ie(this, b, "f")), (0, n2.QP)(this, ie(this, _, "f")) && "development" === ie(this, k, "f"))
                    return console.info(re.A.cannotOpenSignUpOrSignUp);
                  ...
                  if (this.assertComponentsReady(ie(this, b, "f")), (0, n2.vV)(this) && "development" === ie(this, k, "f"))
                    return console.info(re.A.cannotOpenUserProfile);
                  ...
                  if (this.assertComponentsReady(ie(this, b, "f")), (0, n2.FW)(this) && "development" === ie(this, k, "f"))
                    return console.info(re.A.cannotOpenOrgProfile);
                  ...
                  if (t3.origin === window.location.origin && r3)
                    return await r3((0, n2.FV)(t3));
                  (0, n2.y7)(t3);
                }, E.set(this, async () => {
                  if (!(0, n2.M)())
                    return;
                  ...
                  if ((0, n2.M)())
                    return this.navigate(this.buildUrlWithAuth(e3));
                }, this.redirectToSignIn = async (e3) => {
                  if ((0, n2.M)())
                    return this.navigate(this.buildSignInUrl(e3));
                }, this.redirectToSignUp = async (e3) => {
                  if ((0, n2.M)())
                    return this.navigate(this.buildSignUpUrl(e3));
                  ...
                  if ((0, e2.io)("handleMagicLinkVerification", "Use `handleEmailLinkVerification` instead."), !this.client)
                    return;
                  const o3 = (0, n2.hI)("__clerk_status");
                  if ("expired" === o3)
                    throw new r2.gS(r2.dB.Expired);
                  if ("verified" !== o3)
                    throw new r2.gS(r2.dB.Failed);
                  ...
                  const o3 = (0, n2.hI)("__clerk_status");
                  if ("expired" === o3)
                    throw new r2.NZ(r2.Ys.Expired);
                  if ("verified" !== o3)
                    throw new r2.NZ(r2.Ys.Failed);
                  const a3 = (0, n2.hI)("__clerk_created_session"), { signIn: s3, signUp: c2, sessions: l2 } = this.client, u2 = l2.some((e3) => e3.id === a3), d2 = "needs_second_factor" === s3.status || "missing_requirements" === c2.status, h2 = (e3) => i3 && "function" == typeof i3 ? i3(e3) : this.navigate(e3), f2 = t3.redirectUrlComplete ? () => h2(t3.redirectUrlComplete) : e2.lQ, p2 = t3.redirectUrl ? () => h2(t3.redirectUrl) : e2.lQ;
                  return u2 ? this.setActive({ session: a3, beforeEmit: f2 }) : d2 ? p2() : ("function" == typeof t3.onVerifiedOnOtherDevice && t3.onVerifiedOnOtherDevice(), null);
                }, this.handleGoogleOneTapCallback = async (e3, t3, n3) => {
                  if (!ie(this, P, "f") || !ie(this, _, "f") || !this.client)
                    return;
                  ...
                  if (!this.loaded || !ie(this, _, "f") || !this.client)
                    return;
                  ...
                  if ("complete" === y2.status)
                    return this.setActive({ session: y2.sessionId, beforeEmit: O2 });
                  ...
                  if ("user_locked" === g2.externalAccountErrorCode)
                    return w2();
                  if (C2)
                    return b2();
                  if ("needs_first_factor" === y2.status)
                    return S2();
                  if ("needs_new_password" === y2.status)
                    return P2();
                  ...
                  if ("complete" === g2.status)
                    return this.setActive({ session: g2.sessionId, beforeEmit: A2 });
                  if ("needs_second_factor" === y2.status)
                    return k2();
                  if (("failed" === g2.externalAccountStatus || "unverified" === g2.externalAccountStatus) && "identifier_already_signed_in" === g2.externalAccountErrorCode && g2.externalAccountSessionId || "failed" === y2.firstFactorVerificationStatus && "identifier_already_signed_in" === y2.firstFactorVerificationErrorCode && y2.firstFactorVerificationSessionId) {
                    ...
                    if (e4)
                      return this.setActive({ session: e4, beforeEmit: O2 });
                  }
                  ...
                  return null === (n3 = this.client) || void 0 === n3 ? void 0 : n3.signIn.create({ strategy: "google_one_tap", token: t3.token }).catch((n4) => {
                    var r3;
                    if ((0, e2.$R)(n4) && "external_account_not_found" === n4.errors[0].code)
                      return null === (r3 = this.client) || void 0 === r3 ? void 0 : r3.signUp.create({ strategy: "google_one_tap", token: t3.token });
                    throw n4;
                  });
                }, this.authenticateWithMetamask = async ({ redirectUrl: e3, signUpContinueUrl: t3, customNavigate: r3, unsafeMetadata: i3 } = {}) => {
                  if (!this.client || !ie(this, _, "f"))
                    return;
                  ...
                  try {
                    ...
                    if (!(0, n2.bJ)(c2, o2.OQ.FORM_IDENTIFIER_NOT_FOUND))
                      throw c2;
                  ...
                  if (this.proxyUrl) {
                    ...
                    this.domain && (e3 = new URL("/v1/client/sync", `https://${this.domain}`));
                  ...
                  if (oe(this, w, function({ frontendApi: e3, fapiClient: t4 }) {
                    ...
                    return { clear: async function() {
                      ...
                      if (h2 && (r3.removeDevBrowserCookie(), r3.setDevBrowserCookie(h2)), i5 && (t4.onBeforeRequest((e4) => {
                        ...
                        return u3 && !r3.getDevBrowserInittedCookie() ? async function() {
                  ...
                  }({ frontendApi: this.frontendApi, fapiClient: ie(this, S, "f") }), "f"), ie(this, $, "f").call(this), ie(this, T, "f").call(this))
                    return await ie(this, L, "f").call(this), false;
                  if ("production" === ie(this, k, "f") ? await ie(this, w, "f").clear() : await ie(this, w, "f").setup(), ie(this, N, "f").call(this))
                    return await ie(this, E, "f").call(this), false;
                  ...
                  for (; i3 < 2; ) {
                    ...
                    try {
                      ...
                      if (this.updateClient(i4), this.updateEnvironment(n3), await ie(this, te, "f").call(this))
                        return false;
                  ...
                  if (!t3 || !ie(this, x, "f").touchSession)
                  ...
                  if (this.client)
                    for (const e3 of ie(this, U, "f"))
                      e3({ client: this.client, session: this.session, user: this.user, organization: this.organization, lastOrganizationInvitation: ie(this, O, "f"), lastOrganizationMember: ie(this, A, "f") });
                }), q.set(this, () => {
                  var e3;
                  ...
                  if (!ie(this, P, "f") || !ie(this, _, "f") || !ie(this, _, "f").displayConfig)
                    return "";
                ...
                }), a2 = (a2 || "").trim(), oe(this, m, null == s2 ? void 0 : s2.domain, "f"), oe(this, g, null == s2 ? void 0 : s2.proxyUrl, "f"), (0, e2.r7)(a2))
                  (0, e2.io)("frontendApi", "Use `publishableKey` instead."), (0, n2.RA)(a2) || n2.sb.throwInvalidFrontendApiError({ key: a2 }), this.frontendApi = a2, oe(this, k, (0, n2.DY)(this.frontendApi) ? "development" : "production", "f");
                else {
                  const t3 = (0, e2.q5)(a2);
              ...
              buildUrlWithAuth(t3) {
                var n3, r3;
                if ("production" === ie(this, k, "f") || !(null === (n3 = ie(this, w, "f")) || void 0 === n3 ? void 0 : n3.usesUrlBasedSessionSync()))
                  return t3;
                const i3 = new URL(t3, window.location.origin);
                if (i3.origin === window.location.origin)
                  return i3.href;
              ...
              (0, ue.UQ)(() => {
                p2 && r3((e4) => ({ ...e4, [Ge[p2.componentName]]: true })), qe.mountComponent = (e4) => {
                  ...
                  if (e4 && n3 && "object" == typeof n3) {
                    ...
                    if (i5)
                      return i5.props = { ...n3 }, void r3((e5) => ({ ...e5 }));
                  }
                  r3((e5) => ({ ...e5, ...i4 }));
                }, qe.closeModal = (e4) => {

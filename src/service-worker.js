    ...
    try {
      ...
      try {
        ...
        if (error.status === 403) {
          ...
          userMessage = "Request timed out. The backend may be slow or unavailable. Please try again.";
          errorCode = 'TIMEOUT';
          ...
          if (errorMsg.includes('403') || errorMsg.includes('forbidden') || 
              ...
              responseText.includes('authentication') || responseText.includes('unauthorized') ||
              responseText.includes('forbidden') || responseText.includes('token')) {
            userMessage = "Authentication required. Please sign in to use analysis features.";
            errorCode = 'AUTH_REQUIRED';
            actionable = true;
          }
          // Network errors
                   ...
                   errorMsg.includes('connection') || errorMsg.includes('cors')) {
